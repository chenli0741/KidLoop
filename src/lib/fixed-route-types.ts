...
export type FixedRoute = {id:string; name:string; routeType:'RECURRING'|'TEMPORARY'; startsOn:string; endsOn:string; weekdays:number[]; driverId:string|null; vehicleId:string|null; enabled:boolean; updatedAt:string; stops:RouteStop[]; students:RouteStudent[]};
