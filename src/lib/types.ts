...
export type AuthUser = { tenantId?: string; tenantName?: string; accountId?: string; contextKey?: string; photoUrl?: string; id: string; email: string; name: string; role: UserRole; driverId: string | null };
